...
#include <auto_rover_base/ParametersConfig.h>
...
namespace auto_rover_base
{
    ...
    public:
        ...
        void updateDynamicReconfig(auto_rover_base::ParametersConfig config);

        /**
         * \brief Update the PID parameters from dynamics reconfigure
         */
        void dynamicReconfigCallback(auto_rover_base::ParametersConfig &config, uint32_t /*level*/);
    ...
    private:
        ...
        typedef dynamic_reconfigure::Server<auto_rover_base::ParametersConfig> DynamicReconfigServer;
