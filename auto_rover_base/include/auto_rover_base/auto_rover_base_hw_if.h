#ifndef AUTO_ROVER_HW_IF
#define AUTO_ROVER_HW_IF
...
#include <auto_rover_msgs/AngularVelocitiesStamped.h>
...
namespace auto_rover_base
{
    ...
    class AutoRoverHWInterface : public hardware_interface::RobotHW
    {
    public:
        /**
         * \brief Constructor
         ...
         */
        AutoRoverHWInterface(ros::NodeHandle &nh, urdf::Model *urdf_model = NULL);

        /** \brief Destructor */
        virtual ~AutoRoverHWInterface() {}
    ...
    protected:
        ...
        void encoderTicksCallback(const auto_rover_msgs::EncodersStamped::ConstPtr& msg_encoders);
