...
namespace auto_rover
{
    ...
    public:
        ...
        /** \brief Construct a AutoRover::Encoder providing access to quadrature encoder ticks and angular joint velocity.
         * 
